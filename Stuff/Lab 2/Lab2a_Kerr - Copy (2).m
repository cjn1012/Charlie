...
Resist_thermistor=[29.37, 29.16, 29.96, 27.93, 26.53, 28.98, 35.35, 27.88, 28.44, 28.85, 12.22, 8.13, 5.82, 3.88, 2.79, 2.05, 1.47, 1.13, .854];%Thermistor Reistance in KOhm
Voltage_thermcouple=[15.35, 27.17, 28.56, 28.54, 28.03, 28.05, 27.67, 29.39, 30.26, 27.86, 223.57, 322.76, 424.45, 526.79, 630.10, 728.29, 833.49, 925.93, 1015];%Thermocouple voltages'
...
plot(Temp_Thermistor, Voltage_thermcouple, 'o')
hold on
fit_1=p(1).*Temp_Thermistor+p(2);
plot(Temp_Thermistor, fit_1)
grid minor
text(0,800, ['V(mV)= ' num2str(p(1)) 'T + ' num2str(p(2)) ' mV'])
axis([-10, 110, 0, 1200])
legend('Data Points', 'Best Fit', 'Location', 'Northwest')
title('Amplified Thermocouple Voltage vs Thermistor Temperature')
...
text(55, 50, ['\leftarrow Confidence Interval of fit = ' num2str(Temp_Thermocouple(5)) ' \pm ' num2str(confit(5)) ], 'FontSize', 8);
text(55, 100, ['Confidence Interval of fit = ' num2str(Temp_Thermocouple(end)) ' \pm ' num2str(confit(end)) ' \rightarrow'], 'FontSize', 8);
text(5, 0, ['\leftarrow Confidence Interval of fit = ' num2str(Temp_Thermocouple(1)) ' \pm ' num2str(confit(1)) ], 'FontSize', 8);
text(10, 80,['t_9_5_%_,_8=' num2str(tnup)])
axis([-2,105, -5, 105])
title('Confidence of Temperature Readings')
...
xlabel('Time (s)')
title('Bare Wire: Boil to Ice (BBI)')
grid minor
...
title('Bare Wire Boil to Ice: 5\sigma and \Gamma Method')
subplot(3,1,2)
...
plot(new_time_start_std_BBI(position_start_std_BBI:end), residual_std_BBI, 'bla.')
grid minor
axis([-1, 2, -100, 100])
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
...
grid minor
legend('Data', 'Best Fit Line')
title('Bare Wire Boil to Ice: Max Slope and \Gamma Method')
axis([-1, 2, -10, 10])
subplot(3,1,2)
% Estimate plot with time constant
for i=1:length(BBI_time)
...
plot(new_time_start_poly_BBI(start_poly_BBI:end), residual_poly_BBI, 'bla.')
grid minor
axis([-1, 2, -100, 100])
ylabel('Temperature (\circ C)')
legend('Residuals')
...
for i=1:length(new_time_start_std_BBI)
    if BBI_Temp_smooth(i)<T_at_Tau_std_BBI
        Tau_std_value_BBI=new_time_start_std_BBI(i);
        break
    end
end
for i=1:length(new_time_start_std_BBI)
...
title('Bare Wire Boil to Ice: 5\sigma and .632 Method')
ylabel('Temperature (\circ C)')
grid minor
hold on
...
plot(new_time_start_std_BBI(position_start_std_BBI:length(residual_value_std_BBI)),residual_value_std_BBI(position_start_std_BBI:length(residual_value_std_BBI)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
axis([-1, 2, -100, 100])
...
for i=1:length(new_time_start_poly_BBI)
    if BBI_Temp_smooth(i)<T_at_Tau_poly_BBI
        Tau_poly_value_BBI=new_time_start_poly_BBI(i);
        break
    end
end
for i=1:length(new_time_start_poly_BBI)
Temp_tau_poly_value_BBI(i)=BBI_temp_final-((BBI_temp_final-Temp_start_poly_BBI)*exp(-new_time_start_poly_BBI(i)/Tau_poly_value_BBI));
end
subplot(2,1,1)
plot(new_time_start_poly_BBI, BBI_Temp_smooth, '.')
hold on
...
ylabel('Temperature (\circ C)')
title('Bare Wire Boil to Ice: Max Slope and .632 Method')
grid minor
axis([-1, 2, -10, 110])
legend('Data', 'Best Fit Line')
%Residuals
...
plot(new_time_start_poly_BBI(start_poly_BBI:length(residual_value_poly_BBI)),residual_value_poly_BBI(start_poly_BBI:length(residual_value_poly_BBI)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
axis([-1, 2, -100, 100])
...
ylabel('Temperature (\circ C)')
xlabel('Time (s)')
title('Bare Wire: Ice to Boil (BIB)')
grid minor
...
grid minor
title('Bare Wire Ice to Boil: 5\sigma and \Gamma Method')
axis([-1, 5, -10, 10])
subplot(3,1,2)
% Estimate plot with time constant
...
plot(new_time_start_std_BIB(position_start_std_BIB:end), residual_std_BIB, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-1,5, -100, 100])
...
grid minor
legend('Data', 'Best Fit Line')
title('Bare Wire Ice to Boil: Max Slope and \Gamma Method')
axis([-1, 5, -10, 10])
subplot(3,1,2)
% Estimate plot with time constant
for i=1:length(BIB_time)
...
plot(new_time_start_poly_BIB(start_poly_BIB:end), residual_poly_BIB, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-1, 5, -100, 100])
...
for i=1:length(new_time_start_std_BIB)
    if BIB_Temp_smooth(i)>T_at_Tau_std_BIB
        Tau_std_value_BIB=new_time_start_std_BIB(i);
        break
    end
end
for i=1:length(new_time_start_std_BIB)
Temp_tau_std_value_BIB(i)=BIB_temp_final-((BIB_temp_final-Temp_start_poly_BIB)*exp(-new_time_start_std_BIB(i)/Tau_std_value_BIB));
end
subplot(2,1,1)
plot(new_time_start_std_BIB, BIB_Temp_smooth, '.')
title('Bare Wire Ice to Boil: 5\sigma and .632 Method')
ylabel('Temperature (\circ C)')
grid minor
hold on
...
plot(new_time_start_std_BIB(position_start_std_BIB:length(residual_value_std_BIB)),residual_value_std_BIB(position_start_std_BIB:length(residual_value_std_BIB)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
axis([-1, 5, -100, 100])
...
for i=1:length(new_time_start_poly_BIB)
    if BIB_Temp_smooth(i)>T_at_Tau_poly_BIB
        Tau_poly_value_BIB=new_time_start_poly_BIB(i);
        break
    end
end
for i=1:length(new_time_start_poly_BIB)
Temp_tau_poly_value_BIB(i)=BIB_temp_final-((BIB_temp_final-Temp_start_poly_BIB)*exp(-new_time_start_poly_BIB(i)/Tau_poly_value_BIB));
end
subplot(2,1,1)
plot(new_time_start_poly_BIB, BIB_Temp_smooth, '.')
hold on
...
ylabel('Temperature (\circ C)')
title('Bare Wire Ice to Boil: Max Slope and .632 Method')
grid minor
axis([-1, 5, -10, 110])
legend('Data', 'Best Fit Line')
%Residuals
...
plot(new_time_start_poly_BIB(start_poly_BIB:length(residual_value_poly_BIB)),residual_value_poly_BIB(start_poly_BIB:length(residual_value_poly_BIB)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
axis([-1, 5, -100, 100])
...
% filter off curving abnormalities at beginning
for i=length(BIA_time):-1:4000
        if BIA_Temp_smooth(i)<12.15
...
title('Bare Wire Ice to Room Temperature Air (BIA)')
figure
...
% filter off curving abnormalities at beginning
for i=length(BIR_time):-1:4000
        if BIR_Temp_smooth(i)<22.16
...
ylabel('Temperature (\circ C)')
xlabel('Time (s)')
title('Bare Wire Ice to Room Temperature Water (BIR)')
grid minor
...
ylabel('Temperature (\circ C)')
xlabel('Time (s)')
title('Embedded Stainless Steel Ice to Boil (EIB SS)')
grid minor
...
grid minor
legend('Data', 'Best Fit Line')
title('Embedded Stainless Steel Ice to Boil: 5\sigma and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
...
plot(new_time_start_std_EIB_SS(position_start_std_EIB_SS:end), residual_std_EIB_SS, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
legend('Residuals')
...
grid minor
legend('Data', 'Best Fit Line')
title('Embedded Stainless Steel Ice to Boil: Max Slope and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
for i=1:length(EIB_SS_time)
...
plot(new_time_start_poly_EIB_SS(start_poly_EIB_SS:end), residual_poly_EIB_SS, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-5, 45, -100, 100])
...
for i=1:length(new_time_start_std_EIB_SS)
    if EIB_SS_Temp_smooth(i)>T_at_Tau_std_EIB_SS
        Tau_std_value_EIB_SS=new_time_start_std_EIB_SS(i);
        break
    end
end
for i=1:length(new_time_start_std_EIB_SS)
Temp_tau_std_value_EIB_SS(i)=EIB_SS_temp_final-((EIB_SS_temp_final-Temp_start_poly_EIB_SS)*exp(-new_time_start_std_EIB_SS(i)/Tau_std_value_EIB_SS));
end
subplot(2,1,1)
plot(new_time_start_std_EIB_SS, EIB_SS_Temp_smooth, '.')
title('Embedded Stainless Steel Ice to Boil: 5\sigma and .632 Method')
ylabel('Temperature (\circ C)')
grid minor
axis([-5, 45, -10, 110])
hold on
...
plot(new_time_start_std_EIB_SS(position_start_std_EIB_SS:length(residual_value_std_EIB_SS)),residual_value_std_EIB_SS(position_start_std_EIB_SS:length(residual_value_std_EIB_SS)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-5, 45, -100, 100])
legend('Residuals')
...
for i=1:length(new_time_start_poly_EIB_SS)
    if EIB_SS_Temp_smooth(i)>T_at_Tau_poly_EIB_SS
        Tau_poly_value_EIB_SS=new_time_start_poly_EIB_SS(i);
        break
    end
end
for i=1:length(new_time_start_poly_EIB_SS)
Temp_tau_poly_value_EIB_SS(i)=EIB_SS_temp_final-((EIB_SS_temp_final-Temp_start_poly_EIB_SS)*exp(-new_time_start_poly_EIB_SS(i)/Tau_poly_value_EIB_SS));
end
subplot(2,1,1)
plot(new_time_start_poly_EIB_SS, EIB_SS_Temp_smooth, '.')
hold on
...
ylabel('Temperature (\circ C)')
title('Embedded Stainless Steel Ice to Boil: Max Slope and .632 Method')
axis([-5, 45, -10, 110])
legend('Data', 'Best Fit Line')
grid minor
...
plot(new_time_start_poly_EIB_SS(start_poly_EIB_SS:length(residual_value_poly_EIB_SS)),residual_value_poly_EIB_SS(start_poly_EIB_SS:length(residual_value_poly_EIB_SS)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
axis([-5, 45, -100, 100])
...
ylabel('Temperature (\circ C)')
xlabel('Time (s)')
title('Embedded Stainless Steel Boil to Ice (EBI SS)')
grid minor
...
grid minor
legend('Data', 'Best Fit Line')
title('Embedded Stainless Steel Boil to Ice: 5\sigma and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
...
plot(new_time_start_std_EBI_SS(position_start_std_EBI_SS:end), residual_std_EBI_SS, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-6, 45, -100, 100])
...
grid minor
legend('Data', 'Best Fit Line')
title('Embedded Stainless Steel Boil to Ice: Max Slope and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
for i=1:length(EBI_SS_time)
...
plot(new_time_start_poly_EBI_SS(start_poly_EBI_SS:end), residual_poly_EBI_SS, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-6, 45, -100, 100])
...
for i=1:length(new_time_start_std_EBI_SS)
    if EBI_SS_Temp_smooth(i)<T_at_Tau_std_EBI_SS
        Tau_std_value_EBI_SS=new_time_start_std_EBI_SS(i);
        break
    end
end
for i=1:length(new_time_start_std_EBI_SS)
Temp_tau_std_value_EBI_SS(i)=EBI_SS_temp_final-((EBI_SS_temp_final-Temp_start_poly_EBI_SS)*exp(-new_time_start_std_EBI_SS(i)/Tau_std_value_EBI_SS));
end
subplot(2,1,1)
plot(new_time_start_std_EBI_SS, EBI_SS_Temp_smooth, '.')
title('Embedded Stainless Steel Boil to Ice: 5\sigma and .632 Method')
ylabel('Temperature (\circ C)')
grid minor
axis([-6, 45, -10, 110])
hold on
...
plot(new_time_start_std_EBI_SS(position_start_std_EBI_SS:length(residual_value_std_EBI_SS)),residual_value_std_EBI_SS(position_start_std_EBI_SS:length(residual_value_std_EBI_SS)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-6, 45, -100, 100])
grid minor
...
for i=1:length(new_time_start_poly_EBI_SS)
    if EBI_SS_Temp_smooth(i)<T_at_Tau_poly_EBI_SS
        Tau_poly_value_EBI_SS=new_time_start_poly_EBI_SS(i);
        break
    end
end
for i=1:length(new_time_start_poly_EBI_SS)
Temp_tau_poly_value_EBI_SS(i)=EBI_SS_temp_final-((EBI_SS_temp_final-Temp_start_poly_EBI_SS)*exp(-new_time_start_poly_EBI_SS(i)/Tau_poly_value_EBI_SS));
end
subplot(2,1,1)
plot(new_time_start_poly_EBI_SS, EBI_SS_Temp_smooth, '.')
hold on
...
ylabel('Temperature (\circ C)')
title('Embedded Stainless Steel Boil to Ice: Max Slope and .632 Method')
axis([-6, 45, -10, 110])
grid minor
legend('Data', 'Best Fit Line')
%Residuals
...
plot(new_time_start_poly_EBI_SS(start_poly_EBI_SS:length(residual_value_poly_EBI_SS)),residual_value_poly_EBI_SS(start_poly_EBI_SS:length(residual_value_poly_EBI_SS)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
axis([-6, 45, -100, 100])
...
ylabel('Temperature (\circ C)')
xlabel('Time (s)')
title('Embedded Aluminum Ice to Boil (EIB AL)')
grid minor
...
grid minor
legend('Data', 'Best Fit Line')
title('Embedded Aluminum Ice to Boil: 5\sigma and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
...
plot(new_time_start_std_EIB_AL(position_start_std_EIB_AL:end), residual_std_EIB_AL, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
axis([-6, 50, -100, 100])
xlabel('Time (sec)')
...
grid minor
axis([-6, 50, -10, 10])
title('Embedded Aluminum Ice to Boil: Max Slope and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
for i=1:length(EIB_AL_time)
...
plot(new_time_start_poly_EIB_AL(start_poly_EIB_AL:end), residual_poly_EIB_AL, 'bla.')
grid minor
ylabel('Temperature (\circ C)')
axis([-6, 50, -100, 100])
xlabel('Time (sec)')
...
for i=1:length(new_time_start_std_EIB_AL)
    if EIB_AL_Temp_smooth(i)>T_at_Tau_std_EIB_AL
        Tau_std_value_EIB_AL=new_time_start_std_EIB_AL(i);
        break
    end
end
for i=1:length(new_time_start_std_EIB_AL)
Temp_tau_std_value_EIB_AL(i)=EIB_AL_temp_final-((EIB_AL_temp_final-Temp_start_poly_EIB_AL)*exp(-new_time_start_std_EIB_AL(i)/Tau_std_value_EIB_AL));
end
subplot(2,1,1)
plot(new_time_start_std_EIB_AL, EIB_AL_Temp_smooth, '.')
title('Embedded Aluminum Ice to Boil: 5\sigma and .632 Method')
ylabel('Temperature (\circ C)')
grid minor
axis([-6, 50, -10, 110])
hold on
...
plot(new_time_start_std_EIB_AL(position_start_std_EIB_AL:length(residual_value_std_EIB_AL)),residual_value_std_EIB_AL(position_start_std_EIB_AL:length(residual_value_std_EIB_AL)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
axis([-6, 50, -100, 100])
legend ('Residuals')
...
for i=1:length(new_time_start_poly_EIB_AL)
    if EIB_AL_Temp_smooth(i)>T_at_Tau_poly_EIB_AL
        Tau_poly_value_EIB_AL=new_time_start_poly_EIB_AL(i);
        break
    end
end
for i=1:length(new_time_start_poly_EIB_AL)
Temp_tau_poly_value_EIB_AL(i)=EIB_AL_temp_final-((EIB_AL_temp_final-Temp_start_poly_EIB_AL)*exp(-new_time_start_poly_EIB_AL(i)/Tau_poly_value_EIB_AL));
end
subplot(2,1,1)
plot(new_time_start_poly_EIB_AL, EIB_AL_Temp_smooth, '.')
hold on
...
ylabel('Temperature (\circ C)')
title('Embedded Aluminum Ice to Boil: Max Slope and .632 Method')
axis([-6, 50, -10, 110])
grid minor
legend('Data', 'Best Fit Line')
%Residuals
...
plot(new_time_start_poly_EIB_AL(start_poly_EIB_AL:length(residual_value_poly_EIB_AL)),residual_value_poly_EIB_AL(start_poly_EIB_AL:length(residual_value_poly_EIB_AL)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
legend ('Residuals')
...
ylabel('Temperature (\circ C)')
xlabel('Time (s)')
title('Embedded Aluminum Boil to Ice (EBI AL)')
grid minor
...
grid minor
title('Embedded Aluminum Boil to Ice: 5\sigma and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
...
plot(new_time_start_std_EBI_AL(position_start_std_EBI_AL:end), residual_std_EBI_AL, 'bla.')
legend('Residuals')
grid minor
ylabel('Temperature (\circ C)')
axis([-6, 50, -100, 100])
...
grid minor
legend('Data', 'Best Fit Line')
title('Embedded Aluminum Boil to Ice: Max Slope and \Gamma Method')
subplot(3,1,2)
% Estimate plot with time constant
for i=1:length(EBI_AL_time)
...
plot(new_time_start_poly_EBI_AL(start_poly_EBI_AL:end), residual_poly_EBI_AL, 'bla.')
legend('Residuals')
grid minor
ylabel('Temperature (\circ C)')
axis([-6, 50, -100, 100])
...
for i=1:length(new_time_start_std_EBI_AL)
    if EBI_AL_Temp_smooth(i)<T_at_Tau_std_EBI_AL
        Tau_std_value_EBI_AL=new_time_start_std_EBI_AL(i);
        break
    end
end
for i=1:length(new_time_start_std_EBI_AL)
Temp_tau_std_value_EBI_AL(i)=EBI_AL_temp_final-((EBI_AL_temp_final-Temp_start_poly_EBI_AL)*exp(-new_time_start_std_EBI_AL(i)/Tau_std_value_EBI_AL));
end
subplot(2,1,1)
plot(new_time_start_std_EBI_AL, EBI_AL_Temp_smooth, '.')
title('Embedded Aluminum Boil to Ice: 5\sigma and .632 Method')
ylabel('Temperature (\circ C)')
grid minor
...
plot(new_time_start_std_EBI_AL(position_start_std_EBI_AL:length(residual_value_std_EBI_AL)),residual_value_std_EBI_AL(position_start_std_EBI_AL:length(residual_value_std_EBI_AL)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
legend('Residuals')
axis([-6, 50, -100, 100])
...
for i=1:length(new_time_start_poly_EBI_AL)
    if EBI_AL_Temp_smooth(i)<T_at_Tau_poly_EBI_AL
        Tau_poly_value_EBI_AL=new_time_start_poly_EBI_AL(i);
        break
    end
end
for i=1:length(new_time_start_poly_EBI_AL)
Temp_tau_poly_value_EBI_AL(i)=EBI_AL_temp_final-((EBI_AL_temp_final-Temp_start_poly_EBI_AL)*exp(-new_time_start_poly_EBI_AL(i)/Tau_poly_value_EBI_AL));
end
subplot(2,1,1)
...
ylabel('Temperature (\circ C)')
title('Embedded Aluminum Boil to Ice: Max Slope and .632 Method')
axis([-6, 50, -10, 110])
legend('Data', 'Best Fit Line')
grid minor
...
plot(new_time_start_poly_EBI_AL(start_poly_EBI_AL:length(residual_value_poly_EBI_AL)),residual_value_poly_EBI_AL(start_poly_EBI_AL:length(residual_value_poly_EBI_AL)), 'bla.')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
legend ('Residuals')
...
title('Residuals of 5\sigma Method found with \Gamma')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
...
nu_BIB=length(BIB_Temp_smooth)-(m_fits+1);
sum_length_BIB_poly_gamma=start_poly_BIB:1:length(Temp_tau_poly_BIB)-25;
...
nu_BBI=length(BBI_Temp_smooth)-(m_fits+1);
sum_length_BBI_std_value=position_start_std_BBI:1:length(Temp_tau_std_value_BBI);
syx_value_std_BBI=(sum((BBI_Temp_smooth(sum_length_std_value_BBI)-Temp_tau_std_value_BBI(sum_length_std_value_BBI)).^2)/nu_BBI).^.5;
...
nu_BIB=length(BIB_Temp_smooth)-(m_fits+1);
sum_length_BIB_std_value=position_start_std_BIB:1:length(Temp_tau_std_value_BIB)-50;
syx_value_std_BIB=(sum((BIB_Temp_smooth(sum_length_BIB_std_value)-Temp_tau_std_value_BIB(sum_length_BIB_std_value)).^2)/nu_BIB).^.5;
...
nu_EIB_SS=length(EIB_SS_Temp_smooth)-(m_fits+1);
sum_length_EIB_SS_std_value=position_start_std_EIB_SS:1:length(Temp_tau_std_value_EIB_SS)-25;
syx_value_std_EIB_SS=(sum((EIB_SS_Temp_smooth(sum_length_EIB_SS_std_value)-Temp_tau_std_value_EIB_SS(sum_length_EIB_SS_std_value)).^2)/nu_EIB_SS).^.5;
...
nu_EBI_SS=length(EBI_SS_Temp_smooth)-(m_fits+1);
sum_length_EBI_SS_std_value=position_start_std_EBI_SS:1:length(Temp_tau_std_value_EBI_SS)-25;
syx_value_std_EBI_SS=(sum((EBI_SS_Temp_smooth(sum_length_EBI_SS_std_value)-Temp_tau_std_value_EBI_SS(sum_length_EBI_SS_std_value)).^2)/nu_EBI_SS).^.5;
...
nu_EIB_AL=length(EIB_AL_Temp_smooth)-(m_fits+1);
sum_length_EIB_AL_std_value=position_start_std_EIB_AL:1:length(Temp_tau_std_value_EIB_AL)-25;
syx_value_std_EIB_AL=(sum((EIB_AL_Temp_smooth(sum_length_EIB_AL_std_value)-Temp_tau_std_value_EIB_AL(sum_length_EIB_AL_std_value)).^2)/nu_EIB_AL).^.5;
...
nu_EBI_AL=length(EBI_AL_Temp_smooth)-(m_fits+1);
sum_length_EBI_AL_std_value=position_start_std_EBI_AL:1:length(Temp_tau_std_value_EBI_AL)-25;
syx_value_std_EBI_AL=(sum((EBI_AL_Temp_smooth(sum_length_EBI_AL_std_value)-Temp_tau_std_value_EBI_AL(sum_length_EBI_AL_std_value)).^2)/nu_EBI_AL).^.5;
...
title('Residuals of 5\sigma Method found with Value of .632')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
legend('BBI', 'BIB', 'EIB SS', 'EBI SS', 'EIB AL', 'EBI AL')
ylim([-20, 20])
...
nu_BBI=length(BBI_Temp_smooth)-(m_fits+1);
sum_length_BBI_poly_value=start_poly_BBI:1:length(Temp_tau_poly_value_BBI);
syx_value_poly_BBI=(sum((BBI_Temp_smooth(sum_length_poly_value_BBI)-Temp_tau_poly_value_BBI(sum_length_poly_value_BBI)).^2)/nu_BBI).^.5;
...
nu_BIB=length(BIB_Temp_smooth)-(m_fits+1);
sum_length_BIB_poly_value=start_poly_BIB:1:length(Temp_tau_poly_value_BIB)-50;
syx_value_poly_BIB=(sum((BIB_Temp_smooth(sum_length_BIB_poly_value)-Temp_tau_poly_value_BIB(sum_length_BIB_poly_value)).^2)/nu_BIB).^.5;
...
nu_EIB_SS=length(EIB_SS_Temp_smooth)-(m_fits+1);
sum_length_EIB_SS_poly_value=start_poly_EIB_SS:1:length(Temp_tau_poly_value_EIB_SS)-25;
syx_value_poly_EIB_SS=(sum((EIB_SS_Temp_smooth(sum_length_EIB_SS_poly_value)-Temp_tau_poly_value_EIB_SS(sum_length_EIB_SS_poly_value)).^2)/nu_EIB_SS).^.5;
...
nu_EBI_SS=length(EBI_SS_Temp_smooth)-(m_fits+1);
sum_length_EBI_SS_poly_value=start_poly_EBI_SS:1:length(Temp_tau_poly_value_EBI_SS)-25;
syx_value_poly_EBI_SS=(sum((EBI_SS_Temp_smooth(sum_length_EBI_SS_poly_value)-Temp_tau_poly_value_EBI_SS(sum_length_EBI_SS_poly_value)).^2)/nu_EBI_SS).^.5;
...
nu_EIB_AL=length(EIB_AL_Temp_smooth)-(m_fits+1);
sum_length_EIB_AL_poly_value=start_poly_EIB_AL:1:length(Temp_tau_poly_value_EIB_AL)-25;
syx_value_poly_EIB_AL=(sum((EIB_AL_Temp_smooth(sum_length_EIB_AL_poly_value)-Temp_tau_poly_value_EIB_AL(sum_length_EIB_AL_poly_value)).^2)/nu_EIB_AL).^.5;
...
nu_EBI_AL=length(EBI_AL_Temp_smooth)-(m_fits+1);
sum_length_EBI_AL_poly_value=start_poly_EBI_AL:1:length(Temp_tau_poly_value_EBI_AL)-25;
syx_value_poly_EBI_AL=(sum((EBI_AL_Temp_smooth(sum_length_EBI_AL_poly_value)-Temp_tau_poly_value_EBI_AL(sum_length_EBI_AL_poly_value)).^2)/nu_EBI_AL).^.5;
...
ylim([-20, 20])
grid minor
set(gcf, 'Position', [50, 25, 1800, 1000])
figure
...
title('Bare Wire Ice to Room Temperature Water vs Room Temperature Air')
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')

%% Make Arrays of Tau and Sxy to Put into Tables

table_std_gamma_Tau=[tau_std_BBI, tau_std_BIB, tau_std_EBI_SS, tau_std_EIB_SS, tau_std_EBI_AL, tau_std_EIB_AL];

table_poly_gamma_Tau=[tau_poly_BBI, tau_poly_BIB, tau_poly_EBI_SS, tau_poly_EIB_SS, tau_poly_EBI_AL, tau_poly_EIB_AL];

table_poly_value_Tau=[Tau_poly_value_BBI, Tau_poly_value_BIB, Tau_poly_value_EBI_SS, Tau_poly_value_EIB_SS, Tau_poly_value_EBI_AL, Tau_poly_value_EIB_AL];

table_std_value_Tau=[Tau_std_value_BBI, Tau_std_value_BIB, Tau_std_value_EBI_SS, Tau_std_value_EIB_SS, Tau_std_value_EBI_AL, Tau_std_value_EIB_AL];


%%%%%%%%%%Syx

table_syx_std_gamma_syx=[syx_gamma_std_BBI, syx_gamma_std_BIB, syx_gamma_std_EBI_SS, syx_gamma_std_EIB_SS, syx_gamma_std_EBI_AL, syx_gamma_std_EIB_AL];

table_syx_poly_gamma=[syx_gamma_poly_BBI, syx_gamma_poly_BIB, syx_gamma_poly_EBI_SS, syx_gamma_poly_EIB_SS, syx_gamma_poly_EBI_AL, syx_gamma_poly_EIB_AL];

table_syx_std_value=[syx_value_std_BBI, syx_value_std_BIB, syx_value_std_EBI_SS, syx_value_std_EIB_SS, syx_value_std_EBI_AL, syx_value_std_EIB_AL];

table_syx_poly_value=[syx_value_poly_BBI, syx_value_poly_BIB, syx_value_poly_EBI_SS, syx_value_poly_EIB_SS, syx_value_poly_EBI_AL, syx_value_poly_EIB_AL];
close all

%% Subplots of Fits for Bare Wire
close all;

subplot(2,2,1)
%Bare Wire Ice to Boil Plots
% Stand Dev methods
...
plot(new_time_start_std_BIB, Temp_tau_std_BIB)
plot(new_time_start_std_BIB, Temp_tau_std_value_BIB)
start_line_time=linspace((new_time_start_std_BIB(position_start_std_BIB)),(new_time_start_std_BIB(position_start_std_BIB)), 1000);
start_line_temp=linspace(-10, 100, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
title({'Bare Wire, Ice to Boil Transition:', ...
         ' 5\sigma Onset Method'})
grid minor
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southeast')
axis([-1,4,-10,100])
text(2,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_std_BIB, 4) , ' \circ C'])
text(2,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_std_BIB, 4) , ' \circ C'])
text(2,50, ['\tau (\Gamma Method) = ' , num2str(tau_std_BIB, 4) , ' sec'])
text(2,40, ['\tau (.632 Method) = ' , num2str(Tau_std_value_BIB, 4) , ' sec'])
% .632 Methods

subplot(2,2,3)
plot(new_time_start_poly_BIB, BIB_Temp_smooth)
title({'Bare Wire, Ice to Boil Transition:', ...
       'Max Slope Onset Method'})
ylabel('Temperature (\circ C)')
xlabel('Time (sec)')
grid minor
hold on
plot(new_time_start_poly_BIB, Temp_tau_poly_BIB)
plot(new_time_start_poly_BIB, Temp_tau_poly_value_BIB)
start_line_time=linspace(new_time_start_poly_BIB(start_poly_BIB), new_time_start_poly_BIB(start_poly_BIB), 10);
start_line_temp=linspace(-10, 100, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
axis([-1,4,-10,100])
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southeast')
text(2,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_poly_BIB, 4) , ' \circ C'])
text(2,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_poly_BIB, 4) , ' \circ C'])
text(2,50, ['\tau (\Gamma Method) = ' , num2str(tau_poly_BIB, 4) , ' sec'])
text(2,40, ['\tau (.632 Method) = ' , num2str(Tau_poly_value_BIB, 4) , ' sec'])
...
hold on
plot(new_time_start_std_BBI, Temp_tau_std_BBI)
title({'Bare Wire, Boil to Ice Transition:', ...
       '5\sigma Onset Method'})
plot(new_time_start_std_BBI, Temp_tau_std_value_BBI)
start_line_time=linspace((new_time_start_std_BBI(position_start_std_BBI)),(new_time_start_std_BBI(position_start_std_BBI)), 1000);
start_line_temp=linspace(-10, 100, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
grid minor
axis([-1, 2, -10, 100])
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southwest')
text(.8,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_std_BBI, 4) , ' \circ C'])
text(.8,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_std_BBI, 4) , ' \circ C'])
text(.8,50, ['\tau (\Gamma Method) = ' , num2str(tau_std_BBI, 4) , ' sec'])
text(.8,40, ['\tau (.632 Method) = ' , num2str(Tau_std_value_BBI, 4) , ' sec'])
...
plot(new_time_start_poly_BBI, Temp_tau_poly_BBI)
plot(new_time_start_poly_BBI, Temp_tau_poly_value_BBI)
start_line_time=linspace(new_time_start_poly_BBI(start_poly_BBI), new_time_start_poly_BBI(start_poly_BBI), 10);
start_line_temp=linspace(-10, 100, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
axis([-1, 2, -10, 100])
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southwest')
text(.8,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_poly_BBI, 4) , ' \circ C'])
text(.8,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_poly_BBI, 4) , ' \circ C'])
text(.8,50, ['\tau (\Gamma Method) = ' , num2str(tau_poly_BBI, 4) , ' sec'])
text(.8,40, ['\tau (.632 Method) = ' , num2str(Tau_poly_value_BBI, 4) , ' sec'])

%% Subplots of Residuals for Bare Wire
close all
subplot(2,1,1)
title('Plot of Residuals for Bare Wire Boil to Ice Transition')
plot(new_time_start_std_BIB(position_start_std_BIB:end), residual_std_BIB)
hold on
plot(new_time_start_poly_BIB(start_poly_BIB:end), residual_poly_BIB)
...
grid minor
ylabel('Temperature (\circ C)')
title('Residuals of Bare Wire, Ice to Boil Tranistion')
xlabel('Time (sec)')
axis([0,2, -80, 80])
legend('\Gamma and 5\sigma', '\Gamma and Max Slope', '.632 and 5\sigma', '.632 and Max Slope')

%Residuals of Boil to Ice
...
grid minor
ylabel('Temperature (\circ C)')
title('Residuals of Bare Wire, Boil to Ice Transition')
xlabel('Time (sec)')
axis([0,2, -80, 80])
legend('\Gamma and 5\sigma', '\Gamma and Max Slope', '.632 and 5\sigma', '.632 and Max Slope')
close all

%% Subplots of Embedded
close all;

subplot(2,2,1)
%Embedded Stainless Steel Ice to Boil Plots
% Stand Dev methods
...
plot(new_time_start_std_EIB_SS, Temp_tau_std_EIB_SS)
plot(new_time_start_std_EIB_SS, Temp_tau_std_value_EIB_SS)
start_line_time=linspace((new_time_start_std_EIB_SS(position_start_std_EIB_SS)),(new_time_start_std_EIB_SS(position_start_std_EIB_SS)), 1000);
start_line_temp=linspace(-10, 110, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
title({'Embedded Stainless Steel, Ice to Boil Transition:', ...
         ' 5\sigma Onset Method'})
grid minor
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southeast')
ylim([-10, 110])
xlim([-10, 40])
text(20,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_std_EIB_SS, 4) , ' \circ C'])
text(20,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_std_EIB_SS, 4) , ' \circ C'])
text(20,50, ['\tau (\Gamma Method) = ' , num2str(tau_std_EIB_SS, 4) , ' sec'])
text(20,40, ['\tau (.632 Method) = ' , num2str(Tau_std_value_EIB_SS, 4) , ' sec'])
% .632 Methods
...
plot(new_time_start_poly_EIB_SS, Temp_tau_poly_EIB_SS)
plot(new_time_start_poly_EIB_SS, Temp_tau_poly_value_EIB_SS)
start_line_time=linspace(new_time_start_poly_EIB_SS(start_poly_EIB_SS), new_time_start_poly_EIB_SS(start_poly_EIB_SS), 10);
start_line_temp=linspace(-10, 110, length(start_line_time));
plot(start_line_time, start_line_temp, '--')

legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southeast')
text(20,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_poly_EIB_SS, 4) , ' \circ C'])
text(20,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_poly_EIB_SS, 4) , ' \circ C'])
text(20,50, ['\tau (\Gamma Method) = ' , num2str(tau_poly_EIB_SS, 4) , ' sec'])
text(20,40, ['\tau (.632 Method) = ' , num2str(Tau_poly_value_BIB, 4) , ' sec'])
...
hold on
plot(new_time_start_std_EBI_SS, Temp_tau_std_EBI_SS)
title({'Embedded Stainless Steel, Boil to Ice Transition:', ...
       '5\sigma Onset Method'})
plot(new_time_start_std_EBI_SS, Temp_tau_std_value_EBI_SS)
start_line_time=linspace((new_time_start_std_EBI_SS(position_start_std_EBI_SS)),(new_time_start_std_EBI_SS(position_start_std_EBI_SS)), 1000);
start_line_temp=linspace(-10, 110, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
grid minor
ylim([-10, 110])
xlim([-10, 45])
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southwest')
text(20,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_std_EBI_SS, 4) , ' \circ C'])
text(20,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_std_EBI_SS, 4) , ' \circ C'])
text(20,50, ['\tau (\Gamma Method) = ' , num2str(tau_std_EBI_SS, 4) , ' sec'])
text(20,40, ['\tau (.632 Method) = ' , num2str(Tau_std_value_EBI_SS, 4) , ' sec'])
...
plot(new_time_start_poly_EBI_SS, Temp_tau_poly_EBI_SS)
plot(new_time_start_poly_EBI_SS, Temp_tau_poly_value_EBI_SS)
start_line_time=linspace(new_time_start_poly_EBI_SS(start_poly_EBI_SS), new_time_start_poly_EBI_SS(start_poly_EBI_SS), 10);
start_line_temp=linspace(-10, 110, length(start_line_time));
plot(start_line_time, start_line_temp, '--')
ylim([-10, 110])
xlim([-10, 45])
legend('Data', '\Gamma Method', '.632 Method', 'Start Time', 'Location', 'southwest')
text(20,80, ['S_Y_X (\Gamma Method) = ' , num2str(syx_gamma_poly_EBI_SS, 4) , ' \circ C'])
text(20,70, ['S_Y_X (.632 Method) = ' , num2str(syx_value_poly_EBI_SS, 4) , ' \circ C'])
text(20,50, ['\tau (\Gamma Method) = ' , num2str(tau_poly_EBI_SS, 4) , ' sec'])
text(20,40, ['\tau (.632 Method) = ' , num2str(Tau_poly_value_EBI_SS, 4) , ' sec'])

%% Close Script Figures
close all