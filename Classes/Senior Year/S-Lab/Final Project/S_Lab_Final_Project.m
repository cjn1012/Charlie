...
ve_b = (tot_thrustb-(b_throatA*(max_Pb)))/m_dotb;  
ve_c = (tot_thrustc-(c_throatA*(max_Pc)))/m_dotc;  
ve_d = (tot_thrustd-(d_throatA*(max_Pd)))/m_dotd;  
...
rd = 1/(((45.2/1000)*9.81)/tot_thrustd); 
rc = 1/(((24.0/1000)*9.81)/tot_thrustc);
rb = 1/(((19.1/1000)*9.81)/tot_thrustb);