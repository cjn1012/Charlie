...
BIW_Temp_Final = mean(BIW_Temp_Smooth(end-1000:end));
...
for i = 1:length(GammaBIW_Log_01)
    SumX = GammaBIW_Log_01(i) * BIW_Time_01(i) + SumX;
...
for i = 1:length(GammaBIW_Log_27)
    SumX = GammaBIW_Log_27(i) * BIW_Time_27(i) + SumX;
    SumY = BIW_Time_27(i)^2 + SumY;
end
CoBIW = SumX/SumY;
FitBIW_27 = CoBIW.*BIW_Time_27;

% Calculating Time Constants for each above


BIB_01_Cons = -BIB_Time_01./GammaBIB_Log_01;
BBI_01_Cons = -BBI_Time_01./GammaBBI_Log_01;
BIW_01_Cons = -BIW_Time_01./GammaBIW_Log_01;
BIB_27_Cons = -BIB_Time_27./GammaBIB_Log_27;
BBI_27_Cons = -BBI_Time_27./GammaBBI_Log_27;
BIW_27_Cons = -BIW_Time_27./GammaBIW_Log_27;
...
hold on
plot(BIW_Time_01,FitBIW_01)
title('Bare Thermocouple Ice to Room-Temp Water Transition from 0-1 Gamma')
xlabel('Time (s)')
ylabel('ln(\gamma)')


figure(13)
plot(BIB_Time_27,GammaBIB_Log_27)
hold on
plot(BIB_Time_27,FitBIB_27)
title('Bare Thermocouple Ice to Boil Transition from 0.2-0.7 Gamma')
xlabel('Time (s)')
ylabel('ln(\gamma)')


figure(14)
plot(BBI_Time_27,GammaBBI_Log_27)
hold on
plot(BBI_Time_27,FitBBI_27)
title('Bare Thermocouple Boil to Ice Transition from 0.2-0.7 Gamma')
xlabel('Time (s)')
ylabel('ln(\gamma)')


figure(15)
plot(BIW_Time_27,GammaBIW_Log_27)
hold on
plot(BIW_Time_27,FitBIW_27)
title('Bare Thermocouple Ice to Room-Temp Water Transition from 0.2-0.7 Gamma')
xlabel('Time (s)')
ylabel('ln(\gamma)')
