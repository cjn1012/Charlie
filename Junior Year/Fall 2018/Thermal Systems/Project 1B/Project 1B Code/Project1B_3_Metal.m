...
Temperature_Environement = 273+50; % Environement Temperature at Apogee
...
Q_Copper = zeros(10000,1);
Q_PVC = zeros(10000,1);
i=1;
r = linspace(.01,10,10000);
for r1 = r
...
set(gca,'fontsize',14)
xlabel('Heat Transfer for Cooling (J/s)','FontSize',20)
