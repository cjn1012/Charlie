function EntropyIdeal,TemperatureIdeal,EntropyActual,TemperatureActual = T_s_Data(Eff_Comp,Eff_Turb,Eff_Nozz)
...
EntropyIdeal = [linesx,s_Combustor,lines2x,s_Reset];
TemperatureIdeal = [linesy,T_Combustor,lines2y,T_Reset];
EntropyActual = [linesnx,s_Combustorn,linesn2x,s_Resetn];
TemperatureActual = [linesny,T_Combustorn,linesn2y,T_Resetn];


% plot(linesx,linesy,s_Combustor,T_Combustor,lines2x,lines2y,s_Reset,T_Reset)
% hold on
% plot(linesnx,linesny,s_Combustorn,T_Combustorn,linesn2x,linesn2y,s_Resetn,T_Resetn)
