function [Range, efficiency3] = RangeExtra(V,Air_D,Q,M)
...
ranges = zeros(M,1);
efficiency3 = Efficiency(20,1500,interp1(Air_D,Pressures,Densities),interp1(Air_D,Temperatures,Densities));
for index = 1:1:M
    W = W_i - index*9.78;
    Cl = W/Fl_NoCl;
